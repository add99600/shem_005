...
router.get('/api/gcm/code', async (req, res) => {
  let connection;
  try{
...
router.post('/api/gcm/code/insert', async (req, res) => {
    let connection;
    try{
      connection = await getDBConnection();
...
router.delete('/api/gcm/code/delete', async (req, res) => {
    let connection;
    try{
      connection = await getDBConnection();
...
router.put('/api/gcm/code/update', async (req, res) => {
    let connection;
    try{
      connection = await getDBConnection();
      ...
      const result = await connection.execute(`
        ...
        { ...bindVars, top_menu: data.TOP_MENU }, { autoCommit: true });
