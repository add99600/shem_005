...
router.get('/api/gcm/code/data', async (req, res) => {
  let connection;
  try{
...
router.post('/api/gcm/code/data/insert', async (req, res) => {
    let connection;
    try{
      connection = await getDBConnection();
...
router.delete('/api/gcm/code/data/delete', async (req, res) => {
    let connection;
    try{
      connection = await getDBConnection();
...
router.put('/api/gcm/code/data/update', async (req, res) => {
    let connection;
    try{
      connection = await getDBConnection();
