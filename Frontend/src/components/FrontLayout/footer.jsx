          ...
          <div class="row">
            ...
            {/* <div class="col-lg-3">
              ...
              <p class="mb-lg-4 mb-0">
                Vestibulum porttitor lorem et vestibulum pharetra. Phasellus sit
                amet mi congue, hendrerit mi ut, dignissim eros.
              </p>
            </div> */}
            ...
            {/* <div class="col-lg-3">
              ...
              <ul class="list-unstyled list-product mb-lg-4 mb-0 p-0">
                <li>
                  <div class="image">
                    <img
                      src="../assets/img/product/product-iphone-6s.jpg"
                      alt=""
                    />
                  </div>
                  <div class="info">
                ...
                <li>
                  <div class="image">
                    <img
                      src="../assets/img/product/product-galaxy-s6.jpg"
                      alt=""
                    />
                  </div>
                  <div class="info">
                ...
                <li>
                  <div class="image">
                    <img
                      src="../assets/img/product/product-ipad-pro.jpg"
                      alt=""
                    />
                  </div>
                  <div class="info">
                ...
                <li>
                  <div class="image">
                    <img
                      src="../assets/img/product/product-galaxy-note5.jpg"
                      alt=""
                    />
                  </div>
                  <div class="info">
            ...
            <div class="col-lg-3">
              <h4 class="footer-header">Copyright © 하나마이크론 2024</h4>
              {/* <address class="mb-lg-4 mb-0">
                ...
                <br />
                <abbr title="Fax">Fax:</abbr> (123) 456-7891
                <br />
                <abbr title="Email">Email:</abbr>{" "}
                <a href="mailto:sales@myshop.com">sales@myshop.com</a>
                <br />
                <abbr title="Skype">Skype:</abbr>{" "}
                <a href="skype:myshop">myshop</a>
              </address> */}
            </div>
          </div>
        </div>
