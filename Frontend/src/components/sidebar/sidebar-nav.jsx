...
function SidebarNav() {
  ...
  function handleSidebarSearch(e) {
    ...
    if (targetValue) {
      ...
      var elms6 = [].slice.call(
        document.querySelectorAll(".app-sidebar:not(.app-sidebar-end) .menu > .menu-item:not(.menu-profile):not(.menu-header):not(.menu-search)")
      );
      if (elms6) {
