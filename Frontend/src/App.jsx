...
import "./syncfusionRegister.css";

// 여기서부터 커스텀 훅 시작
import useUserInfo from "./components/User/useUserInfo.jsx";

function App() {
  // 커스텀 로직 사용
  const { isSuccess, isLoading } = useUserInfo();
  const navigate = useNavigate();

  console.log("isUserValid", isSuccess);
